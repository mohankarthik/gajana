...
class AxisBank:
    ...
    def update(self) -> None:
        ...
        web.click_element(
            By.XPATH,
            "/html/body/app-root/mat-sidenav-container/mat-sidenav-content/div/app-homepage/div/div/mat-sidenav-container/mat-sidenav-content/div[1]/span/div/div/div[2]/app-cards-flyout/div/div/div[2]/div",
        )
        ...
        with open(self._csv_path, "r") as csv_file:
            ...
            for row in reader:
                if len(row) > 1 and re.search(r"\d{2}\-\d{2}\-\d{4}", row[0]):
                    self._data.append(
                        Transaction(
                            row[0], row[2], row[3], row[4], row[5], self._account
                        )
                    )
    ...
    def _captcha(self, web: Web) -> None:
        try:
            question = web.get_element(
                By.XPATH,
                "/html/body/app-root/mat-sidenav-container/mat-sidenav-content/div/app-homepage/div/div/div/div/app-s504/div/div/mat-card/mat-card-content/div/div[5]/div/div/div",
            ).text
        except:
        ...
        elem = web.get_element(
            By.XPATH,
            "/html/body/app-root/mat-sidenav-container/mat-sidenav-content/div/app-homepage/div/div/div/div/app-s504/div/div/mat-card/mat-card-content/div/div[5]/div/div/div/div/mat-form-field/div/div[1]/div/input",
        )
        ...
        web.click_element(
            By.XPATH,
            "/html/body/app-root/mat-sidenav-container/mat-sidenav-content/div/app-homepage/div/div/div/div/app-s504/div/div/mat-card/mat-card-content/div/div[6]/button[1]",
        )
