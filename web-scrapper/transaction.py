...
class Transaction:
  def __init__(self, date: str, description: str, credit: str, debit: str, balance: str, account: str) -> None:
    self.date: datetime.datetime = datetime.datetime.strptime(date.strip(), "%d-%m-%Y")
