...
class TestGajanaE2E(unittest.TestCase):
    ...
    def test_e2e_skeleton_no_op(self):
        ...
        bank_work_path = os.path.join(self.working_dir, f"{BANK_TRANSACTIONS_SHEET_NAME}.csv")
        cc_work_path = os.path.join(self.working_dir, f"{CC_TRANSACTIONS_SHEET_NAME}.csv")
